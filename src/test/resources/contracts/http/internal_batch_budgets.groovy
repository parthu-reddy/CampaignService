 ...
 *
 * timeZone is the advertiser's: the daily budget resets at midnight on that calendar. The two
 * campaigns belong to advertisers in different zones on purpose -- the zone is per advertiser.
 */
